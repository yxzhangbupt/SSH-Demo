        ...
        <tr>
          <td valign="top">		  <table width="494">
            <tr>
              ...
              <td width="437" valign="bottom"><font color="#66583D"><b>员工管理&nbsp;</b></font>&gt; <font color="#FF0000"> 员工信息更改</font></td>
            </tr>
          </table></td>
        </tr>
      </table>
 ...
 <html:form action="employee.do?method=updateEmployee" onsubmit="return checkEmptyForm(employeeForm)">
		  <table border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="66583D">
            <tr>
              ...
              <td width="200" bgcolor="#FFFFFF"><html:text property="em_serialNumber"  readonly="readonly" onclick="alert('此文本框已设为只读，用户不能修改')"/></td>
              <th width="75">姓名：</th>
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><html:text property="em_createName"  readonly="readonly" onclick="alert('此文本框已设为只读，用户不能修改')"/></td>
              <th>登记时间：</th>                                                              
              <td bgcolor="#FFFFFF"><html:text property="em_creatime"  readonly="readonly" onclick="alert('此文本框已设为只读，用户不能修改')"/></td>
            </tr>
			<tr>
           ...
           <html:hidden property="id"/>
             <html:submit>修改</html:submit> &nbsp; <html:reset>重置</html:reset> &nbsp; <html:button property="back" value="返回" onclick="javascript:history.go(-1);"></html:button>
     </html:form>
